...
public class UserDao {
    ...
    public List<Meeting> userList(String username, int page, int limit) {
        List<Meeting> userList = new ArrayList<>();
    ...
    public Meeting login(String userName, String password) {
        try {
            ...
            Meeting user = this.findUserByUserName(userName);
     ...
     * @return
     */
    private Meeting findUserByUserName(String username) {
        Meeting user = new Meeting();
    ...
    public Meeting register(String userName, String trueName, String email, String password, int roleId) {
        Meeting newUser = new Meeting();
        Meeting oldUser = this.findUserByUserName(userName);
        try {
